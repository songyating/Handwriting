        ...
        passwordInput.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    passwordInput.setBackground(ContextCompat.getDrawable(ForgotPasswordActivity.this,R.drawable.text_border_selector));
                }
            }
        ...
        codeInput.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    ...
                    codeInput.setBackground(ContextCompat.getDrawable(ForgotPasswordActivity.this,R.drawable.text_border_selector));
                }
            }
