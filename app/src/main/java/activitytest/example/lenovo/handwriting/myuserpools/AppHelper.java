...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-east-1_F6uQh4WdE";

    /**
     * Add you app id
     */
    private static final String clientId = "2lu3p8eq115ndkqft31cdjepsv";
     ...
     */
    private static final String clientSecret = "2b4sbojep3rrhdsk3hisrpjdf2lsqj99v1jchde8lo5j95konca";

    /**
     * Set Your User Pools region.
     * e.g. if your user pools are in US East (N Virginia) then set cognitoRegion = Regions.US_EAST_1.
     */
    private static final Regions cognitoRegion = Regions.fromName("us-east-1");
