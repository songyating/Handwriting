...
public class VerifyActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        if (AppHelper.isEmailAvailable()) {
            if (AppHelper.isEmailVerified()) {
                ...
                reqEmailVerf.setBackground(ContextCompat.getDrawable(this, R.drawable.button_success));
        ...
        if (AppHelper.isPhoneAvailable()) {
            if (AppHelper.isPhoneVerified()) {
                ...
                reqPhoneVerf.setBackground(ContextCompat.getDrawable(this, R.drawable.button_success));
    ...
    private void reqEmailCode() {
        attrReqCode = "email";
        reqEmailVerf.setBackground(ContextCompat.getDrawable(this, R.drawable.button_selected));
    ...
    private void reqPhoneCode() {
        ...
        reqPhoneVerf.setBackground(ContextCompat.getDrawable(this, R.drawable.button_selected));
    ...
    private void sendVerfCode() {
        ...
        if (code == null) {
            ...
            verifCode.setBackground(ContextCompat.getDrawable(this, R.drawable.text_border_error));
            return;
        }
